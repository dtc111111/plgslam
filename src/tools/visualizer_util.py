...
def create_camera_actor(i, is_gt=False, scale=0.005):
    ...
    color = (0.0, 1.0, 0.0) if is_gt else (.0, .0, .0)
        ...
        while True:
            try:
                ...
                if data[0] == 'pose':
                    ...
                    color = (0.0, 1.0, 0.0) if is_gt else (.0, .0, .0)
#[242/255.0 153/255.0 65/255.0;  207/255.0 69/255.0 49/255.0;110/255.0 171/255.0 212/255.0; 52/255.0 80/255.0 158/255.0; 0 0 0
                    if is_gt:
        ...
        if save_rendering:
            ...
            vis.capture_screen_image(
                f'{output}/tmp_rendering/{draw_trajectory.frame_idx:06d}.jpg', do_render=True)
