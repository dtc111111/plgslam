...
#
# This file is a modified version of https://github.com/cvg/nice-slam/blob/master/src/tools/eval_recon.py
...
def calc_2d_metric(rec_meshfile, gt_meshfile, align=True, n_imgs=1000):
    ...
    #unseen_gt_pointcloud_file = gt_meshfile.replace('scene0000_00_vh_clean_culled.ply', 'gt_pc_unseen.npy')
